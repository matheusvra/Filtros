...
CutFrequency11 = 5;
CutFrequency1 = 15;
NormCOF1 =  (CutFrequency11*2)/FrequencySampling;
NormCOF2 =  (CutFrequency1*2)/FrequencySampling;

order = 120;
f = [0 NormCOF1 NormCOF2 1];
a = [0 0 1 1];
b = firpm(order,f,a);
a = 1;
figure
...
CutFrequency21 = 15;
CutFrequency2 = 25;
NormCOF1 =  (CutFrequency21*2)/FrequencySampling;
NormCOF2 =  (CutFrequency2*2)/FrequencySampling;
