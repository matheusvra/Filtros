...
CutFrequency1 = 5;
order = 4;
[b,a] = butter(order,(2*CutFrequency1)/FrequencySampling,'high');
figure
...
CutFrequency2 = 25;
[b,a] = butter(order,(2*CutFrequency2)/FrequencySampling,'high');
%FilteredVector =  filter(b,a,VectorOut);
...
%figure= fft_plot(VectorOut,N,FrequencySampling);
t_trans = N/16;
figure
...
%{
f=fopen('Testa_Butter.txt','w');
fprintf(f,'Resultados do Teste do Filtro ButterWorth\n');
