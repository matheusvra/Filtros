...
fft_plot(Signal,N,FrequencySampling,'Original Signal')
...
b = fir1(order,(2*CutFrequency1)/FrequencySampling,'high');
a = 1;
figure
freqz(b,a,512);                 % Frequency response of filter
%{
%Design a Chebyshev 2 filter 
[b,a] = cheby2(3,6,(2*CutFrequency)/FrequencySampling,'high');
%}
figure
subplot(1,2,1)
plot(t,Vector,'k','LineWidth',3)
...
CutFrequency2 = 25;
b = fir1(order,(2*CutFrequency2)/FrequencySampling,'high');
a = 1;
...
fft_plot(FilteredVector,N,FrequencySampling,'Filtered Integrated')
t_trans = N/16;
figure
...
%{
f=fopen('Testa_FIR1.txt','w');
fprintf(f,'Resultados do Teste do Filtro FIR1\n');
